...
+ (UIColor *)colorWithIntValue:(NSInteger)_RGBValue alpha:(CGFloat)_alpha
{
    int r = 0xFF & _RGBValue;
    int g = 0xFF00 & _RGBValue;
    g >>= 8;
    int b = 0xFF0000 & _RGBValue;
    b >>= 16;
    
    return [UIColor colorWithRed:r/256.0 green:g/256.0 blue:b/256.0 alpha:_alpha];
}
